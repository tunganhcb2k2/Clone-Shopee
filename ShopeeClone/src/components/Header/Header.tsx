            ...
            renderPopover={
              <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
                <div className='flex flex-col py-2 pr-28 pl-3'>
                  <button className='py-2 px-3 hover:text-orange cursor-pointer'>Tiếng Việt</button>
                  <button className='py-2 px-3 hover:text-orange cursor-pointer mt-2'>English</button>
                </div>
              </div>
            }
          >
                ...
                <div className='bg-white relative shadow-md rounded-sm border border-gray-200 max-w-[400px] text-sm'>
                  <div className='p2'>
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://down-vn.img.susercontent.com/file/vn-11134207-81ztc-mmg8zkym1zi800'
                            alt='anh'
                        ...
                        <div className='flex-grow ml-2 overflow-hidden'>
                          <div className='truncate'>
                            Set, Bộ phông MIB nam nữ cao cấp, 100% cotton co giãn 2 chiều ,thấm hút mồ hôi - hàng cao,
                            cấp chất lượng - Đen
                          </div>
                        </div>
                        <div className='ml-2 flex-shrink-0'>
                          <span className='text-orange'>450.000₫</span>
                        </div>
                      </div>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                    ...
                    <div className='flex mt-6 items-center justify-between'>
                      ...
                      <button className='capitalize bg-orange hover:opacity-90 px-4 py-2 rounded-sm text-white cursor-pointer'>
                        Xem giỏ hàng
                      </button>
                    </div>
                  </div>
